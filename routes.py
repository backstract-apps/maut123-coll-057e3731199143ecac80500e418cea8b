...
@router.post('/persons/')
async def post_persons( rollnumber: str, fullname: str, age: str, profession: str, maut: str , db: Session = Depends(get_db)):
    return await service.post_persons(db , rollnumber, fullname, age, profession, maut)
